...
func TestValidateNameRejectsUnsafeNames(t *testing.T) {
	cases := map[string]string{
		...
		"windows device dotted":      "con.1",
		"windows device extension":   "nul.baseline",
		"windows device dotted case": "COM1.a",
		"windows device png ext":     "aux.png",
	}
