...
func TestToolsReturnErrorWhenNotConnected(t *testing.T) {
	...
	tests := []struct {
		...
		{"godot_get_accessibility_tree", s.handleGetAccessibilityTree, nil},
		...
		{"godot_focus_window", s.handleFocusWindow, nil},
...
func TestInvalidSelectorReturnsError(t *testing.T) {
	...
	tests := []struct {
		...
		{"godot_focus_window", s.handleFocusWindow, map[string]any{"selector": invalidSelector}},
